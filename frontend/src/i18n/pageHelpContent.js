const PAGE_HELP = {
  ...
  news: {
    en: {
      title: 'News',
      overview: 'Publish announcements for a church. Choose where each item appears: dashboard home, public landing, hero slider, banner, and/or newsletter.',
      steps: [
        'Select the target church (admins with multiple churches).',
        'Create a news item with title, summary, and full content.',
        'Choose one or more publish destinations under “Where to publish”.',
        'Pick the target audience: general, church only, or a specific club.',
        'Set publish date, optional category tag, and status to active when ready.',
        'Edit or deactivate outdated announcements.',
      ],
      fields: [
        { name: 'Title', description: 'Headline shown on selected surfaces.' },
        { name: 'Summary', description: 'Short preview before “Read more” or on landing cards.' },
        { name: 'Content', description: 'Full HTML body of the announcement.' },
        { name: 'Where to publish', description: 'Dashboard, landing page, hero slider, standalone banner, and/or newsletter (multi-select).' },
        { name: 'Target audience', description: 'General (everyone), church only, or club only with a required club selector.' },
        { name: 'Category tag', description: 'Optional label on landing cards and banners (e.g. Events).' },
        { name: 'Publish date', description: 'Controls ordering; future dates hide public surfaces until that day.' },
        { name: 'Status', description: 'Only active news is shown on selected surfaces.' },
      ],
    },
    es: {
      title: 'Noticias',
      overview: 'Publique anuncios para una iglesia. Elija dónde aparece cada noticia: panel de inicio, landing pública, slider superior, banner o boletín.',
      steps: [
        ...
        'Marque uno o más destinos en “Dónde publicar”.',
        'Elija la audiencia: general, solo iglesia o un club específico.',
        'Configure fecha de publicación, categoría opcional y estado activo cuando esté lista.',
        'Edite o desactive anuncios obsoletos.',
      ],
      fields: [
        { name: 'Título', description: 'Encabezado en los destinos seleccionados.' },
        { name: 'Resumen', description: 'Vista previa breve en el panel o tarjetas de la landing.' },
        { name: 'Contenido', description: 'Cuerpo HTML completo del anuncio.' },
        { name: 'Dónde publicar', description: 'Panel, landing, slider hero, banner independiente y/o boletín (multi-selección).' },
        { name: 'Audiencia', description: 'General (todos), solo iglesia, o solo club con selector obligatorio.' },
        { name: 'Etiqueta de categoría', description: 'Etiqueta opcional en tarjetas y banners (ej. Eventos).' },
        { name: 'Fecha de publicación', description: 'Controla el orden; fechas futuras ocultan superficies públicas hasta ese día.' },
        { name: 'Estado', description: 'Solo las noticias activas se muestran en los destinos seleccionados.' },
      ],
    },
  },
  ...
  landingCms: {
    ...
    es: {
      ...
      fields: [
        ...
        { name: 'Icono', description: 'Identificador visual para tarjetas (Conquistadores, Aventureros, Guías Mayores).' },
      ],
      tips: [
  ...
  login: {
    en: {
      ...
      tips: [
        'The landing page describes Teofila features for visitors who are not yet logged in.',
      ],
    },
    es: {
      ...
      tips: [
        'La página de bienvenida describe las funciones de Teofila para visitantes sin sesión.',
      ],
    },
  },
