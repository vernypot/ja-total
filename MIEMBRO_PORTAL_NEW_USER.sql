-- =============================================================================
-- Member portal: PIN only for new users (first login), members list admin status
-- Run in Supabase Dashboard → SQL Editor after MIEMBRO_PORTAL_TRUST_ADMIN.sql
-- =============================================================================
...
COMMENT ON COLUMN public.miembro_profile_tokens.portal_activated_at IS
  'Set when the member completes their first PIN login. After this, QR-only login is allowed.';
