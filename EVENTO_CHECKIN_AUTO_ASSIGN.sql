-- =============================================================================
-- Event QR check-in: auto-assign club members who scan but were not pre-assigned
-- Run in Supabase Dashboard → SQL Editor after EVENTOS + MIEMBRO_CARNET schemas
-- =============================================================================
