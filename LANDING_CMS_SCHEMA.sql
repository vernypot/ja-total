...
VALUES
  ...
  ('programs', 'grid', 3, 'clubes',
   ...
   'Cada tipo de club tiene su identidad, especialidades y metas — todo apoyado por Meissa.',
   'Each club type has its own identity, honors, and milestones — all supported by Meissa.',
   NULL, NULL),
  ('about', 'content', 4, NULL,
   'Acerca de Meissa', 'About Meissa',
