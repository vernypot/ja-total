...
VALUES
  ...
  ('programs', 'grid', 3, 'clubes',
   ...
   'Cada tipo de club tiene su identidad, especialidades y metas — todo apoyado por Acutus.',
   'Each club type has its own identity, honors, and milestones — all supported by Acutus.',
   NULL, NULL),
  ('about', 'content', 4, NULL,
   'Acerca de Acutus', 'About Acutus',
