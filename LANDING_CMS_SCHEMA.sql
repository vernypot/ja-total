...
VALUES
  ...
  ('programs', 'grid', 3, 'clubes',
   ...
   'Cada tipo de club tiene su identidad, especialidades y metas — todo apoyado por Teófila.',
   'Each club type has its own identity, honors, and milestones — all supported by Teofila.',
   NULL, NULL),
  ('about', 'content', 4, NULL,
   'Acerca de Teófila', 'About Teofila',
  ...
  ('footer', 'content', 8, NULL, NULL, NULL, NULL, NULL,
   'Plataforma digital para ministerios juveniles adventistas: Aventureros, Conquistadores y Guías Mayores.',
...
FROM (VALUES
  ('hero', 'slide', 1,
   '{"eyebrow":"Miembros · perfiles · fotos","title":"Registros de miembros en un solo lugar","text":"Datos personales, contactos de emergencia, foto con recorte antes de guardar y estado activo por club — vinculados a su iglesia y club."}',
   '{"eyebrow":"Members · profiles · photos","title":"Member records in one place","text":"Personal data, emergency contacts, crop-before-save photos, and active status per club — linked to your church and club structure."}',
   '{"accent":"gold","screenshot":"members"}'),
  ('hero', 'slide', 2,
   '{"eyebrow":"Clases · especialidades · avances","title":"Siga el avance de cada miembro","text":"Clases progresivas, especialidades y cargos del club con historial por miembro — sin planillas dispersas."}',
   '{"eyebrow":"Classes · specialties · progress","title":"Track each member''s advancement","text":"Progressive classes, specialties, and club roles with per-member history — no more scattered spreadsheets."}',
   '{"accent":"teal","screenshot":"progress"}'),
  ('hero', 'slide', 3,
   '{"eyebrow":"Eventos · calendario · carnets","title":"Eventos y carnets listos para imprimir","text":"Calendario del club, tipos de evento, asistencia e impresión de carnets en malla 3×3 tamaño carta."}',
   '{"eyebrow":"Events · calendar · ID cards","title":"Events and printable club ID cards","text":"Club calendar, event types, attendance, and letter-size carnet sheets in a 3×3 layout ready to print."}',
   '{"accent":"navy","screenshot":"carnets"}'),
  ('hero', 'hero_card', 99,
...
FROM (VALUES
  ...
  ('programs', 'program', 2,
   ...
   '{"icon":"pathfinders"}'),
  ('programs', 'program', 3,
   '{"title":"Guías Mayores","text":"Desarrollo de liderazgo para jóvenes que mentoran a sus pares en el club."}',
